...
-- Dump completed on 2020-07-24  9:51:24
create user 'usuariBorsa'@'192.168.%.%' identified by 'Katzenzungen64';
grant all  ON borsa.* to 'usuariBorsa'@'192.168.%.%';

alter user 'usuariWeb'@'localhost' identified by 'Katzenzungen64';
grant SELECT, EXECUTE, INSERT, UPDATE, DELETE ON borsa.* to 'usuariWeb';